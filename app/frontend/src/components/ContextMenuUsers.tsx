        ...
        options={[
            ...
            ...(isOwner ? [
            {
                ...
                submenu : [
                    {
                        label: "Kick user",
                        onClick:()=>{console.log("kick User" ,"pop a modal asking for how long and a reason")}
                    },
                    {
                        label: "Ban user",
                        onClick:()=>{console.log("Ban user", "pop a modal asking are you sure")}
                    },
                    {
                        label: "Mute user",
                        onClick:()=>(console.log("Mute User", "Pop a modal asking for how long and why"))
                    }
                ]
            }] : [])
        ]}
