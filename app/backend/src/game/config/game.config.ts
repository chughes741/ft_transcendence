...
export class GameConfig {
  ...
  static readonly topRight: Vec2 = {
    x: GameConfig.playAreaWidth / 2,
    y: GameConfig.playAreaHeight / 2
  };
  static readonly botLeft: Vec2 = {
    x: -(GameConfig.playAreaWidth / 2),
    y: -(GameConfig.playAreaHeight / 2)
  };
  static readonly botRight: Vec2 = {
    x: GameConfig.playAreaWidth / 2,
    y: -(GameConfig.playAreaHeight / 2)
  };
...
export class PaddleConfig {
  ...
  static readonly paddleLeftTop: Vec2 = {
    x: -(GameConfig.playAreaWidth / 2) + PaddleConfig.borderOffset,
    y: GameConfig.playAreaHeight / 2
  };
  static readonly paddleLeftBot: Vec2 = {
    x: -(GameConfig.playAreaWidth / 2) + PaddleConfig.borderOffset,
    y: -(GameConfig.playAreaHeight / 2)
  };
  static readonly paddleRightTop: Vec2 = {
    x: GameConfig.playAreaWidth / 2 - PaddleConfig.borderOffset,
    y: GameConfig.playAreaHeight / 2
  };
  static readonly paddleRightBot: Vec2 = {
    x: GameConfig.playAreaWidth / 2 - PaddleConfig.borderOffset,
    y: -(GameConfig.playAreaHeight / 2)
  };
}
